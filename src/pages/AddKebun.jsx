        ...
        Swal.fire({
            ...
            if (confirmResult.isConfirmed) {
                try {
                    ...
                    const response = await axios.post('http://localhost:3000/farms/create', formData, {
                        headers: {
                            'Authorization': `${token}`
                        }
                    });
            ...
            <div className="px-5 bg-white rounded-lg shadow-md w-2/4 mx-auto mt-10">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-2 mb-4">
                        <label htmlFor="farmName">Nama Kebun :</label>
                        <input className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="farmName" value={formData.farmName} onChange={handleChange} placeholder="Nama Kebun" />
                    </div>
                    <div className="flex flex-col gap-2 mb-4">
                        <label htmlFor="estate">Estate :</label>
                        <input className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="estate" value={formData.estate} onChange={handleChange} placeholder="Estate" />
                    </div>
                    <div className="flex flex-col gap-2 mb-4">
                        <label htmlFor="farmAddress">Alamat Kebun :</label>
                        <input className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="farmAddress" value={formData.farmAddress} onChange={handleChange} placeholder="Alamat Kebun" />
                    </div>
                    <div className="flex flex-col gap-2 mb-4">
                        <label htmlFor="dockName">Dermaga Sandar :</label>
                        <input className="shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="dockName" value={formData.dockName} onChange={handleChange} placeholder="Dermaga Sandar" />
                    </div>
                    <div className="flex flex-col gap-2 mb-4">
